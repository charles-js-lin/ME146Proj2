%% Task 6(a) Problem Statement
% a) Iterate over a range of rc and n to recommend system parameters.
...
% Iterate over 10 points for both 5(a) and 5(b)

for h=1:length(rc_range)
T_pv = [200, 0, 300];
% 5(a)
% ID = ID_range(h);%[W/m^2]
% rc = 15; %unitless
...
fprintf("Error and ErrorEQ has converged to 0 \n" +...
    "Error = " + error(2) + "\n" + ... 
    "ErrorEQ = " + errorEQ(2) + "\n");
syms IL_te
...
col = [rc; eff_pv_result; eff_result; eff_tot; P_tot; T_pv_final];
disp(rc);
results = [results col];
